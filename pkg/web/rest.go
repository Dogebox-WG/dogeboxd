...
func RESTAPI(
	...
	recoveryRoutes := map[string]http.HandlerFunc{
		...
		"GET /system/tailscale/state":         a.getTailscaleState,
		"PUT /system/tailscale/state":         a.setTailscaleState,
		"PUT /system/tailscale/config":        a.setTailscaleConfig,
		"GET /system/tailscale/status":        a.getTailscaleStatus,
